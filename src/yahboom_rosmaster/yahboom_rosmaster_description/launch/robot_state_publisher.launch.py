...
# Dynamic Path Setup:
    # Find the source config directory relative to where this launch file is actually located
    launch_dir = os.path.dirname(__file__)
    pkg_source_dir = os.path.abspath(os.path.join(launch_dir, '..'))
    
    src_config_path = os.path.join(pkg_source_dir, 'config', robot_name)
    
    # Dynamically find the install share config directory using ROS 2 utilities
